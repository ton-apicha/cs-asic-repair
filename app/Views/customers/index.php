...
<div class="container-fluid">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <input type="text" class="form-control" id="searchInput" placeholder="<?= lang('App.searchCustomer') ?>"
                onkeyup="searchTable()">
        </div>
    </div>
                ...
                <table class="table table-hover mb-0" id="customersTable">
                    ...
                    <tbody>
                        <?php if (empty($customers)): ?>
                            <tr>
                                <td colspan="5" class="text-center text-muted py-4"><?= lang('App.noCustomersFound') ?></td>
                            </tr>
                        <?php else: ?>
                            <?php foreach ($customers as $customer): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="d-lg-none d-md-none small text-muted mt-1">
                                            <i
                                                class="bi bi-calendar me-1"></i><?= date('d/m/Y', strtotime($customer['created_at'])) ?>
                                        </div>
                                    </td>
                                    <td class="d-none d-md-table-cell">
                                        <?= $customer['email'] ? esc($customer['email']) : '<span class="text-muted">-</span>' ?>
                                    </td>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <a href="<?= base_url('jobs/create') ?>?customer_id=<?= $customer['id'] ?>"
                                                class="btn btn-outline-success" title="<?= lang('App.newJob') ?>">
